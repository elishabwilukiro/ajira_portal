     ...
     <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden">
               ...
               <div className="bg-gradient-to-r from-violet-600 to-indigo-600 px-8 py-6 relative">
                    <button
                         onClick={onClose}
                         className="absolute top-4 right-4 text-white/70 hover:text-white transition p-1 rounded-lg hover:bg-white/10 cursor-pointer"
                    >
                    ...
                    <form  className="space-y-6">
                         ...
                         <div>
                              ...
                              <div className="mb-4">
                                   ...
                                   <span className="text-gray-400 font-normal ml-1">(PDF only, max 10MB)</span>
                                   </label>

                                   <label className="flex items-center gap-3 border-2 border-dashed border-gray-200 hover:border-violet-300 hover:bg-gray-50 rounded-xl p-4 cursor-pointer transition">
                                   ...
                                   <div className="min-w-0 flex-1">
                                        ...
                                        <p className="text-xs text-gray-400 mt-0.5">PDF format only</p>
                                   </div>
                                   <input type="file" name="resume" accept=".pdf" className="hidden" />
                                   </label>
                              </div>
                         ...
                         <button
                              type="submit"
                              className="w-full py-3.5 bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-violet-700 hover:to-indigo-700 transition shadow-lg shadow-violet-200 flex items-center justify-center gap-2 cursor-pointer"
                         >
